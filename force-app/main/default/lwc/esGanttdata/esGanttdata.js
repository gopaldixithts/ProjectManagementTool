...
import saveTask from '@salesforce/apex/ES_GanttCtrl.saveTask';
import {NavigationMixin} from 'lightning/navigation';
import LightningConfirm from 'lightning/confirm';

export default class ESGanttdata extends NavigationMixin(LightningElement) {
    record;
    recordurl;
    recordPageRef;
    @api startDate;
    ...
    handleDragEnd(event) {
        try {
            ...
            if(this.record.objAPIName=='ES_Task__c'){
                 this._saveTask({
    ...
    get isESPhase() {
        return this.record.objAPIName == 'ES_Phase__c' ? true : false;
    }
